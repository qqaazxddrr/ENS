...
def set_up_logger(args, sys_argv, testing=False):
    # set up running log
    ...
    if not testing:
        ...
        file_path = 'log/neg_sample/{}_{}_{}_{}.log'.format(time_value.strftime('%Y_%m_%d_%h_%m'),args.prefix, args.neg_sample, args.data) #TODO: improve log name
    ...
    return logger, get_checkpoint_path, best_model_path, file_path
