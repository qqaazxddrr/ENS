...
from utils.utils import EarlyStopMonitor, RandEdgeSampler, get_neighbor_finder, RandEdgeSampler_CLScheduler
...
fh = logging.FileHandler('log/{}_{}_{}.log'.format(time_value.strftime('%Y_%m_%d'), args.prefix, args.data))
...
for i in range(args.n_runs):
  ...
  for epoch in range(NUM_EPOCH):
    ...
    for k in range(0, num_batch, args.backprop_every):
      ...
      optimizer.zero_grad()
      if k%50==0:
        logger.info('start {} batch'.format(k))
...
summerize('log/{}_{}_{}.log'.format(time_value.strftime('%Y_%m_%d'), args.prefix, args.data)) 